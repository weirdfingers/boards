...
class Query:
    ...
    async def my_boards(
        ...
        return await resolve_my_boards(info, limit, offset)
    ...
    async def public_boards(
        ...
        return await resolve_public_boards(info, limit, offset)
    
    @strawberry.field
    async def generation(self, info, id: UUID) -> Optional[Generation]:
    ...
    async def recent_generations(
        ...
        return await resolve_recent_generations(
            info, board_id, status, artifact_type, limit, offset
        )
    ...
    async def search_boards(
        ...
        return await search_boards(info, query, limit, offset)