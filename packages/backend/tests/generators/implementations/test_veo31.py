...
class TestVeo31Input:
    """Tests for Veo31Input schema."""

    def test_valid_input(self):
        """Test valid input creation."""
        input_data = Veo31Input(
    ...
    def test_input_defaults(self):
        """Test default values."""
        input_data = Veo31Input(prompt="Test prompt")
    ...
    def test_invalid_aspect_ratio_square(self):
        """Test validation fails for 1:1 aspect ratio (not supported in Veo 3.1)."""
        with pytest.raises(ValidationError):
            Veo31Input(
                prompt="Test",
...
class TestFalVeo31Generator:
    ...
    def test_generator_metadata(self):
        ...
        assert self.generator.name == "fal-veo31"
    ...
    def test_input_schema(self):
        ...
        assert schema_class == Veo31Input
    ...
    async def test_generate_no_video_returned(self):
        ...
        input_data = Veo31Input(prompt="test")
    ...
    def test_json_schema_generation(self):
        ...
        schema = Veo31Input.model_json_schema()
