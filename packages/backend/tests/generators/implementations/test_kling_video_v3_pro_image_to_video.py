"""
Tests for FalKlingVideoV3ProImageToVideoGenerator.
"""
...
class TestKlingVideoV3ProImageToVideoInput:
    """Tests for KlingVideoV3ProImageToVideoInput schema."""
    ...
    def test_valid_input(self):
        ...
        input_data = KlingVideoV3ProImageToVideoInput(
    ...
    def test_cfg_scale_validation(self):
        ...
        input_min = KlingVideoV3ProImageToVideoInput(
            prompt="Test", image_url=image_artifact, cfg_scale=0.0
        )
        assert input_min.cfg_scale == 0.0

        input_max = KlingVideoV3ProImageToVideoInput(
    ...
    def test_prompt_max_length(self):
        ...
        long_prompt = "a" * 2500
        input_data = KlingVideoV3ProImageToVideoInput(prompt=long_prompt, image_url=image_artifact)
        assert len(input_data.prompt) == 2500

        # This should fail (over limit)
        too_long_prompt = "a" * 2501
        with pytest.raises(ValidationError):
            KlingVideoV3ProImageToVideoInput(prompt=too_long_prompt, image_url=image_artifact)
...
class TestFalKlingVideoV3ProImageToVideoGenerator:
    """Tests for FalKlingVideoV3ProImageToVideoGenerator."""
    ...
    def test_generator_metadata(self):
        ...
        assert self.generator.name == "fal-kling-video-v3-pro-image-to-video"
    ...
    def test_input_schema(self):
        ...
        assert schema_class == KlingVideoV3ProImageToVideoInput
    ...
    async def test_generate_successful_5_second_video(self):
        ...
        with patch.dict(os.environ, {"FAL_KEY": "fake-key"}):
            ...
            # Verify API call - note: v3 uses start_image_url instead of image_url
    ...
    async def test_estimate_cost_10_second_without_audio(self):
        ...
        # 10-second video without audio: $0.112/sec * 10 = $1.12
        assert cost == pytest.approx(1.12)
        assert isinstance(cost, float)

    def test_json_schema_generation(self):
        """Test that input schema can generate JSON schema for frontend."""
        schema = KlingVideoV3ProImageToVideoInput.model_json_schema()
