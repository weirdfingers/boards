"""
Tests for FalWanProImageToVideoGenerator.
"""
...
class TestWanProImageToVideoInput:
    """Tests for WanProImageToVideoInput schema."""
    ...
    def test_valid_input(self):
        ...
        input_data = WanProImageToVideoInput(
            image=image,
            prompt=prompt,
            seed=42,
    ...
    def test_safety_checker_false(self):
...
class TestFalWanProImageToVideoGenerator:
    """Tests for FalWanProImageToVideoGenerator."""
    ...
    def test_generator_metadata(self):
        ...
        assert self.generator.name == "fal-wan-pro-image-to-video"
        assert self.generator.artifact_type == "video"
        assert "WAN-Pro" in self.generator.description
        assert "1080p" in self.generator.description

    def test_input_schema(self):
        """Test input schema."""
        schema_class = self.generator.get_input_schema()
        assert schema_class == WanProImageToVideoInput
    ...
    async def test_generate_with_seed(self):
        """Test successful generation with seed parameter."""
        image = ImageArtifact(
            generation_id="gen1",
            storage_url="https://example.com/input.png",
            format="png",
    ...
    def test_json_schema_generation(self):
        ...
        schema = WanProImageToVideoInput.model_json_schema()
