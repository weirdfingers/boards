"""
Tests for FalCreatifyLipsyncGenerator.
"""
...
class TestCreatifyLipsyncInput:
    """Tests for CreatifyLipsyncInput schema."""
...
class TestFalCreatifyLipsyncGenerator:
    """Tests for FalCreatifyLipsyncGenerator."""
    ...
    def test_generator_metadata(self):
        ...
        assert self.generator.name == "fal-creatify-lipsync"
    ...
    def test_input_schema(self):
        ...
        assert schema_class == CreatifyLipsyncInput
    ...
    async def test_generate_successful(self):
        ...
        fake_output_url = "https://v3.fal.media/files/koala/5whrKcxcHTTXzGNcep_MV_output.mp4"
    ...
    @pytest.mark.asyncio
    async def test_generate_successful_with_loop_false(self):
        """Test successful generation with loop disabled."""
        video_artifact = VideoArtifact(
            generation_id="gen_input_video",
            storage_url="https://example.com/input-video.mp4",
            format="mp4",
        ...
        fake_output_url = "https://v3.fal.media/files/koala/abc123_output.mp4"
        fake_uploaded_video_url = "https://fal.media/files/uploaded-video.mp4"
        ...
        with patch.dict(os.environ, {"FAL_KEY": "fake-key"}):
            ...
            # Verify API call used loop=False
            call_args = mock_fal_client.submit_async.call_args
            assert call_args[1]["arguments"]["loop"] is False
    ...
    def test_json_schema_generation(self):
        ...
        schema = CreatifyLipsyncInput.model_json_schema()
        ...
        # Check loop is boolean type
        loop_prop = schema["properties"]["loop"]
        assert loop_prop["type"] == "boolean"
