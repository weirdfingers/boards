...
class TestVeo3Input:
    """Tests for Veo3Input schema."""

    def test_valid_input(self):
        """Test valid input creation."""
        input_data = Veo3Input(
    ...
    def test_input_defaults(self):
        """Test default values."""
        input_data = Veo3Input(prompt="Test prompt")
...
class TestFalVeo3Generator:
    ...
    def test_generator_metadata(self):
        ...
        assert self.generator.name == "fal-veo3"
        assert self.generator.artifact_type == "video"
        assert "Veo 3" in self.generator.description
        assert "Google" in self.generator.description

    def test_input_schema(self):
        """Test input schema."""
        schema_class = self.generator.get_input_schema()
        assert schema_class == Veo3Input
    ...
    async def test_generate_square_aspect_ratio(self):
        ...
        with patch.dict(os.environ, {"FAL_KEY": "fake-key"}):
            ...
            # Verify API call with square aspect ratio
            call_args = mock_fal_client.submit_async.call_args
    ...
    async def test_generate_no_video_returned(self):
        ...
        input_data = Veo3Input(prompt="test")
    ...
    def test_json_schema_generation(self):
        ...
        schema = Veo3Input.model_json_schema()
