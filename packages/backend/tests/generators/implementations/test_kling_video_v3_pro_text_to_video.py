"""
Tests for FalKlingVideoV3ProTextToVideoGenerator.
"""
...
class TestKlingVideoV3ProTextToVideoInput:
    """Tests for KlingVideoV3ProTextToVideoInput schema."""

    def test_valid_input(self):
        """Test valid input creation."""
        input_data = KlingVideoV3ProTextToVideoInput(
    ...
    def test_cfg_scale_validation(self):
        ...
        input_min = KlingVideoV3ProTextToVideoInput(prompt="Test", cfg_scale=0.0)
        assert input_min.cfg_scale == 0.0

        input_max = KlingVideoV3ProTextToVideoInput(prompt="Test", cfg_scale=1.0)
    ...
    def test_prompt_max_length(self):
        ...
        long_prompt = "a" * 2500
        input_data = KlingVideoV3ProTextToVideoInput(prompt=long_prompt)
        assert len(input_data.prompt) == 2500

        # This should fail (over limit)
        too_long_prompt = "a" * 2501
        with pytest.raises(ValidationError):
            KlingVideoV3ProTextToVideoInput(prompt=too_long_prompt)

    def test_negative_prompt_max_length(self):
        """Test negative_prompt max length validation."""
        # This should succeed (exactly at limit)
        long_negative = "a" * 2500
        input_data = KlingVideoV3ProTextToVideoInput(prompt="test", negative_prompt=long_negative)
        assert len(input_data.negative_prompt) == 2500

        # This should fail (over limit)
        too_long_negative = "a" * 2501
        with pytest.raises(ValidationError):
            KlingVideoV3ProTextToVideoInput(prompt="test", negative_prompt=too_long_negative)
...
class TestFalKlingVideoV3ProTextToVideoGenerator:
    """Tests for FalKlingVideoV3ProTextToVideoGenerator."""
    ...
    def test_generator_metadata(self):
        ...
        assert self.generator.name == "fal-kling-video-v3-pro-text-to-video"
    ...
    def test_input_schema(self):
        ...
        assert schema_class == KlingVideoV3ProTextToVideoInput
    ...
    async def test_estimate_cost_5_second_with_audio(self):
        ...
        # 5-second video with audio: $0.168/sec * 5 = $0.84
    ...
    async def test_estimate_cost_10_second_with_audio(self):
        ...
        # 10-second video with audio: $0.168/sec * 10 = $1.68
        assert cost == pytest.approx(1.68)
        assert isinstance(cost, float)

    @pytest.mark.asyncio
    async def test_estimate_cost_5_second_without_audio(self):
        """Test cost estimation for 5-second video without audio."""
        input_data = KlingVideoV3ProTextToVideoInput(
            prompt="Test prompt",
            duration="5",
            generate_audio=False,
        ...
        # 5-second video without audio: $0.112/sec * 5 = $0.56
        assert cost == pytest.approx(0.56)
        assert isinstance(cost, float)

    def test_json_schema_generation(self):
        """Test that input schema can generate JSON schema for frontend."""
        schema = KlingVideoV3ProTextToVideoInput.model_json_schema()
