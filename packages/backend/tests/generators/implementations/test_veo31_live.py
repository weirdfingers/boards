"""
Live API tests for FalVeo31Generator.
...
To run these tests:
    ...
    pytest tests/generators/implementations/test_veo31_live.py -v -m live_api

Or using direct environment variable:
    export FAL_KEY="..."
    pytest tests/generators/implementations/test_veo31_live.py -v -m live_fal
...
from boards.generators.implementations.fal.video.veo31 import (
    FalVeo31Generator,
    Veo31Input,
)
...
class TestVeo31GeneratorLive:
    """Live API tests for FalVeo31Generator using real Fal.ai API."""

    def setup_method(self):
        """Set up generator and ensure API keys are synced to environment."""
        self.generator = FalVeo31Generator()
    ...
    async def test_generate_basic(self, skip_if_no_fal_key, dummy_context, cost_logger):
        ...
        """
        # Log estimated cost
        estimated_cost = await self.generator.estimate_cost(Veo31Input(prompt="test"))
        ...
        inputs = Veo31Input(
            ...
            aspect_ratio="16:9",  # Standard format
    ...
    async def test_estimate_cost_matches_pricing(self, skip_if_no_fal_key):
        ...
        inputs_with_audio = Veo31Input(prompt="test", generate_audio=True)
        cost_with_audio = await self.generator.estimate_cost(inputs_with_audio)

        # Test without audio (50% cost)
        inputs_without_audio = Veo31Input(prompt="test", generate_audio=False)
