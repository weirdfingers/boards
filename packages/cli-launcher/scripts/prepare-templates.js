...
if (fs.existsSync(webPkgPath)) {
  ...
  // Transform workspace:* to ^VERSION
...
# This file will be generated by the CLI with proper configuration
...
services:
  ...
  api:
    image: weirdfingers/baseboards-api:\${VERSION:-latest}
    env_file: docker/.env
    depends_on:
      db:
  ...
  web:
    image: weirdfingers/baseboards-web:\${VERSION:-latest}
    environment:
