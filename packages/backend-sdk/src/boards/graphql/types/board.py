...
class BoardMember:
    ...
    @strawberry.field
    async def inviter(self, info) -> Optional["User"]:
...
class Board:
    ...
    @strawberry.field
    async def members(self, info) -> List[BoardMember]:
    ...
    async def generations(
        ...
        return await resolve_board_generations(self, info, limit, offset)
    
    @strawberry.field
    async def generation_count(self, info) -> int:
