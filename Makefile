...
FRONTEND_FILTER := --filter=@weirdfingers/boards... --filter=@weirdfingers/auth-clerk... --filter=@weirdfingers/auth-jwt... --filter=@weirdfingers/auth-supabase... --filter=example-nextjs...
